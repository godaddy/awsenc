...
mod tests {
    ...
    fn roundtrip_json_protocol() {
        ...
        let init_json = r#"{"method":"init","params":{"app_name":"awsenc","key_label":"cache-key","access_policy":"none"}}"#;
        let encrypt_json = r#"{"method":"encrypt","params":{"data":"aGVsbG8gd29ybGQ=","app_name":"awsenc","key_label":"cache-key","access_policy":"none"}}"#;
        let destroy_json =
